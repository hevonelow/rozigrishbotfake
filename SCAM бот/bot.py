...
# ============== КОНФИГ В КОДЕ ==============
BOT_TOKEN = "8116019368:AAFK-xBhAvCbgYAmS4dNyb8M7Nd9mb8ghKU"
CHANNEL_USERNAME = "snckintr"             # без @
ORGANIZER_LINK = "https://t.me/soqys"
ORGANIZER_ADMIN_ID = 7738555379           # твой Telegram ID (кто может /admin, /set_*, /end)
GIVEAWAY_CODE = "632"
PRIZE_COUNT = 3
PRIZE_2_NAME = "100 долларов"
